...
const buttonElems = {
    ...
    17: document.getElementById('ButtonAssist'),
...
const updateController = () => {
    ...
    buttonElems.LStick.style.transform = `translate(${buttons['lx'] * 2}%, ${buttons['ly'] * 2}%)`;
    buttonElems.RStick.style.transform = `translate(${buttons['rx'] * 2}%, ${buttons['ry'] * 2}%)`;
}
